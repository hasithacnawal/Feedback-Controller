...
@Component({
  selector: "app-all-orgadmin",
  templateUrl: "./all-orgadmin.component.html",
  styleUrls: ["./all-orgadmin.component.sass"],
})
export class AllOrgadminComponent implements OnInit {
  displayedColumns = [
    "select",
    "img",
    "name",
