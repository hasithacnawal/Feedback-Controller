...
export class AllOrganizationsComponent implements OnInit {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.exampleDatabase.dataChange.value.unshift(
          this.organizationService.getDialogData()
        );
        this.refreshTable();
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<Organization>(true, []);
    });
    this.showNotification(
      "snackbar-danger",
  ...
  public loadData() {
    this.exampleDatabase = new OrganizationService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Organization> {
  ...
  constructor(
    public exampleDatabase: OrganizationService,
  ...
  connect(): Observable<Organization[]> {
    ...
    this.exampleDatabase.getAllOrganizations();
